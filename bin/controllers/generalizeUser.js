...
function getGeneralizeUser(req, res) {
...
exports.getGeneralizeUser = getGeneralizeUser;
;
function setGeneralizeUser(req, res) {
    var dataAll = req.body;
...
exports.setGeneralizeUser = setGeneralizeUser;
